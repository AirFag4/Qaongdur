          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-sm leading-6 text-stone-300">
                Sign in or create an account directly from this page. Keycloak still
                handles authentication and passkeys while the app keeps the same
                backend role checks.
              </p>
            </div>
            {!error ? (
              <div className="flex flex-wrap gap-3">
                ...
                <Button size="lg" variant="secondary" onClick={() => void onRegister?.()}>
